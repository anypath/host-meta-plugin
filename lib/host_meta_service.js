...
function HostMetaService(options) {
  this.gatewayd = options.gatewayd;
}

HostMetaService.prototype = {
  constructor: HostMetaService,
  ...
  build: function build() {
    ...
    hostMeta.links = _this.gatewayd.hostMeta ? _this.gatewayd.hostMeta.links : [];

    return Promise.resolve(hostMeta);
  }
};

module.exports = HostMetaService;
